...
def model_page(request):
    ...
    if request.method == 'POST':
        ...
        r = requests.get("https://www.kinopoisk.ru/lists/movies/top250/", headers=header)
        ...
        all_rating = bs.find_all("span", class_="styles_kinopoiskValuePositive__vOb2E styles_kinopoiskValue__9qXjg styles_top250Type__mPloU")
